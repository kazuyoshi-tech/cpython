...
#define unless_stmt_type 1031
#define elunless_stmt_type 1032
#define while_stmt_type 1033
#define for_stmt_type 1034
#define with_stmt_type 1035
#define with_item_type 1036
#define try_stmt_type 1037
#define except_block_type 1038
#define finally_block_type 1039
#define return_stmt_type 1040
#define raise_stmt_type 1041
#define function_def_type 1042
#define function_def_raw_type 1043
#define func_type_comment_type 1044
#define params_type 1045
#define parameters_type 1046
#define slash_no_default_type 1047
#define slash_with_default_type 1048
#define star_etc_type 1049
#define kwds_type 1050
#define param_no_default_type 1051
#define param_with_default_type 1052
#define param_maybe_default_type 1053
#define param_type 1054
#define annotation_type 1055
#define default_type 1056
#define decorators_type 1057
#define class_def_type 1058
#define class_def_raw_type 1059
#define block_type 1060
...
#define lambda_params_type 1070
#define lambda_parameters_type 1071
#define lambda_slash_no_default_type 1072
#define lambda_slash_with_default_type 1073
#define lambda_star_etc_type 1074
#define lambda_kwds_type 1075
#define lambda_param_no_default_type 1076
#define lambda_param_with_default_type 1077
#define lambda_param_maybe_default_type 1078
#define lambda_param_type 1079
#define disjunction_type 1080
#define conjunction_type 1081
#define inversion_type 1082
#define comparison_type 1083
#define compare_op_bitwise_or_pair_type 1084
#define eq_bitwise_or_type 1085
#define noteq_bitwise_or_type 1086
#define lte_bitwise_or_type 1087
#define lt_bitwise_or_type 1088
#define gte_bitwise_or_type 1089
#define gt_bitwise_or_type 1090
#define notin_bitwise_or_type 1091
#define in_bitwise_or_type 1092
#define isnot_bitwise_or_type 1093
#define is_bitwise_or_type 1094
...
#define sum_type 1099  // Left-recursive
#define term_type 1100  // Left-recursive
#define factor_type 1101
#define power_type 1102
#define await_primary_type 1103
#define primary_type 1104  // Left-recursive
#define slices_type 1105
#define slice_type 1106
#define atom_type 1107
#define strings_type 1108
#define list_type 1109
#define listcomp_type 1110
#define tuple_type 1111
#define group_type 1112
#define genexp_type 1113
#define set_type 1114
#define setcomp_type 1115
#define dict_type 1116
#define dictcomp_type 1117
#define double_starred_kvpairs_type 1118
#define double_starred_kvpair_type 1119
#define kvpair_type 1120
#define for_if_clauses_type 1121
#define for_if_clause_type 1122
#define yield_expr_type 1123
#define arguments_type 1124
#define args_type 1125
#define kwargs_type 1126
#define starred_expression_type 1127
#define kwarg_or_starred_type 1128
#define kwarg_or_double_starred_type 1129
#define star_targets_type 1130
#define star_targets_seq_type 1131
...
#define _tmp_120_type 1282
#define _loop0_122_type 1283
#define _gather_121_type 1284
#define _loop0_124_type 1285
#define _gather_123_type 1286
#define _tmp_125_type 1287
#define _loop0_126_type 1288
#define _loop0_127_type 1289
#define _loop0_128_type 1290
#define _tmp_129_type 1291
#define _tmp_130_type 1292
#define _loop0_131_type 1293
#define _tmp_132_type 1294
#define _loop0_133_type 1295
#define _tmp_134_type 1296
...
#define _loop1_151_type 1313
#define _loop1_152_type 1314
#define _tmp_153_type 1315
#define _tmp_154_type 1316
...
static stmt_ty elunless_stmt_rule(Parser *p);
...
compound_stmt_rule(Parser *p)
{
    ...
    { // &'unless' unless_stmt
        ...
        D(fprintf(stderr, "%*c> compound_stmt[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "&'unless' unless_stmt"));
        stmt_ty unless_stmt_var;
        if (
            _PyPegen_lookahead_with_int(1, _PyPegen_expect_token, p, 511)  // token='unless'
            &&
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s compound_stmt[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "&'unless' unless_stmt"));
    }
    { // &('class' | '@') class_def
        if (p->error_indicator) {
            D(p->level--);
    ...
    { // &'try' try_stmt
        ...
        if (
            _PyPegen_lookahead_with_int(1, _PyPegen_expect_token, p, 512)  // token='try'
            &&
    ...
    { // &'while' while_stmt
        ...
        if (
            _PyPegen_lookahead_with_int(1, _PyPegen_expect_token, p, 513)  // token='while'
            &&
...
// unless_stmt:
//     | 'unless' named_expression ':' block elunless_stmt
//     | 'unless' named_expression ':' block else_block?
static stmt_ty
unless_stmt_rule(Parser *p)
{
    ...
    { // 'unless' named_expression ':' block elunless_stmt
        ...
        D(fprintf(stderr, "%*c> unless_stmt[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "'unless' named_expression ':' block elunless_stmt"));
        Token * _keyword;
        Token * _literal;
        expr_ty a;
        asdl_stmt_seq* b;
        stmt_ty c;
        if (
            (_keyword = _PyPegen_expect_token(p, 511))  // token='unless'
            &&
            (a = named_expression_rule(p))  // named_expression
            &&
            (_literal = _PyPegen_expect_token(p, 11))  // token=':'
            ...
            (b = block_rule(p))  // block
            &&
            (c = elunless_stmt_rule(p))  // elunless_stmt
        )
        {
            D(fprintf(stderr, "%*c+ unless_stmt[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'unless' named_expression ':' block elunless_stmt"));
            Token *_token = _PyPegen_get_last_nonnwhitespace_token(p);
            if (_token == NULL) {
                D(p->level--);
                return NULL;
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s unless_stmt[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "'unless' named_expression ':' block elunless_stmt"));
    }
    { // 'unless' named_expression ':' block else_block?
        if (p->error_indicator) {
            D(p->level--);
        ...
        D(fprintf(stderr, "%*c> unless_stmt[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "'unless' named_expression ':' block else_block?"));
        Token * _keyword;
        Token * _literal;
        expr_ty a;
        asdl_stmt_seq* b;
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s unless_stmt[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "'unless' named_expression ':' block else_block?"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// elunless_stmt:
//     | 'elunless' named_expression ':' block elunless_stmt
//     | 'elunless' named_expression ':' block else_block?
static stmt_ty
elunless_stmt_rule(Parser *p)
{
    D(p->level++);
    if (p->error_indicator) {
        D(p->level--);
    ...
    { // 'elunless' named_expression ':' block elunless_stmt
        ...
        D(fprintf(stderr, "%*c> elunless_stmt[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "'elunless' named_expression ':' block elunless_stmt"));
        Token * _keyword;
        Token * _literal;
        expr_ty a;
        asdl_stmt_seq* b;
        stmt_ty c;
        if (
            (_keyword = _PyPegen_expect_token(p, 518))  // token='elunless'
            &&
            (a = named_expression_rule(p))  // named_expression
            &&
            (_literal = _PyPegen_expect_token(p, 11))  // token=':'
        ...
        {
            D(fprintf(stderr, "%*c+ elunless_stmt[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'elunless' named_expression ':' block elunless_stmt"));
            Token *_token = _PyPegen_get_last_nonnwhitespace_token(p);
            if (_token == NULL) {
                D(p->level--);
                return NULL;
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s elunless_stmt[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "'elunless' named_expression ':' block elunless_stmt"));
    }
    { // 'elunless' named_expression ':' block else_block?
        if (p->error_indicator) {
            D(p->level--);
        ...
        D(fprintf(stderr, "%*c> elunless_stmt[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "'elunless' named_expression ':' block else_block?"));
        Token * _keyword;
        Token * _literal;
        expr_ty a;
        asdl_stmt_seq* b;
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s elunless_stmt[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "'elunless' named_expression ':' block else_block?"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
while_stmt_rule(Parser *p)
{
    ...
    { // 'while' named_expression ':' block else_block?
        ...
        void *c;
        if (
            (_keyword = _PyPegen_expect_token(p, 513))  // token='while'
            &&
            (a = named_expression_rule(p))  // named_expression
            &&
            (_literal = _PyPegen_expect_token(p, 11))  // token=':'
...
try_stmt_rule(Parser *p)
{
    ...
    { // 'try' ':' block finally_block
        ...
        asdl_stmt_seq* f;
        if (
            (_keyword = _PyPegen_expect_token(p, 512))  // token='try'
            &&
            (_literal = _PyPegen_expect_token(p, 11))  // token=':'
            &&
            (b = block_rule(p))  // block
...
function_def_raw_rule(Parser *p)
{
    ...
    { // 'def' NAME '(' params? ')' ['->' expression] ':' func_type_comment? block
        ...
        void *tc;
        if (
            (_keyword = _PyPegen_expect_token(p, 525))  // token='def'
            &&
...
class_def_raw_rule(Parser *p)
{
    ...
    { // 'class' NAME ['(' arguments? ')'] ':' block
        ...
        asdl_stmt_seq* c;
        if (
            (_keyword = _PyPegen_expect_token(p, 526))  // token='class'
            &&
            (a = _PyPegen_name_token(p))  // NAME
            &&
...
lambdef_rule(Parser *p)
{
    ...
    { // 'lambda' lambda_params? ':' expression
        ...
        expr_ty b;
        if (
            (_keyword = _PyPegen_expect_token(p, 527))  // token='lambda'
            &&
...
atom_rule(Parser *p)
{
    ...
    { // 'True'
        ...
        Token * _keyword;
        if (
            (_keyword = _PyPegen_expect_token(p, 530))  // token='True'
        )
        {
            D(fprintf(stderr, "%*c+ atom[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'True'"));
            Token *_token = _PyPegen_get_last_nonnwhitespace_token(p);
